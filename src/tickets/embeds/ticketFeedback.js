...
const embed = (ticketCreator, ticketCloser) => {
    const feedbackEmbed = new EmbedBuilder(ticketCreator, ticketCloser)
        ...
        .setDescription(
            'Thank you for reaching out to us. We hope we were able to assist you.\n\nWe would appreciate it if you could take a moment to provide feedback on your experience with the buttons below. Please leave a honest review so we can work on a better team! **Please also leave a review here for a FREE PRODUCT!!** https://forms.gle/XgpPPDBsxigKjgiw6 '
        )
        .setFields(
            {
                name: 'Opened by',
